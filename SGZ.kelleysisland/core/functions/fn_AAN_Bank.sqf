...
_header = "The Bank of Union City";
_line = "The Bank of Union City is being robbed by some rebel(s). The police have urged calmness as they respond to the matter, any civilians are to evacuate the area as police will kill on sight";
