...
private _vaultHouse = [[["kelleysisland", "Land_Research_house_V1_F"], ["Tanoa", "Land_Medevac_house_V1_F"]]] call TON_fnc_terrainSort;
private _altisArray = [16019.5,16952.9,0];
private _tanoaArray = [11074.2,11501.5,0.00137329];
private _pos = [[["kelleysisland", _altisArray], ["Tanoa", _tanoaArray]]] call TON_fnc_terrainSort;
