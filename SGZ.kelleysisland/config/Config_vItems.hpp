...
class VirtualShops {
    ...
    class rebel {
        ...
        items[] = { "waterBottle", "zipties", "blindfold", "speedbomb", "codeCracker", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge" };
    };
    ...
    class gang {
        ...
        side = "civ";
        conditions = "";
        items[] = { "waterBottle", "zipties", "blindfold", "codeCracker", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge" };
    };
    ...
    class cop {
        ...
        side = "cop";
        conditions = "";
        items[] = { "keycard", "spikeStrip", "donuts", "coffee", "waterBottle", "rabbit", "apple", "redgull", "toolkit", "fuelFull", "defusekit" };
    };
};
