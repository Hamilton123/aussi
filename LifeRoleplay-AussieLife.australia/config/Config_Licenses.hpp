...
class Licenses {
	...
	class businessowner {
        ...
        displayName = "STR_License_BusinessOwner";
        price = 120000;
        illegal = false;
        side = "civ";
    };
	...
	class wholesaler_clothing {
        variable = "wholesaler_clothing";
        displayName = "STR_License_ClothingWhole";
        price = 10000;
        illegal = false;
        side = "civ";
    };

	class wholesaler_supermarket {
        variable = "wholesaler_supermarket";
        displayName = "STR_License_Supermarket";
        price = 18000;
        illegal = false;
        side = "civ";
    };

	class wholesaler_firearms {
        variable = "wholesaler_firearms";
        displayName = "STR_License_Firearms";
        price = 25000;
        illegal = false;
        side = "civ";
    };

	class wholesaler_cars {
        variable = "wholesaler_cars";
        displayName = "STR_License_Cars";
        price = 28000;
        illegal = false;
        side = "civ";
    };

	class wholesaler_miscellaneous {
        variable = "wholesaler_miscellaneous";
        displayName = "STR_License_M";
        price = 58000;
        illegal = false;
        side = "civ";
    };
