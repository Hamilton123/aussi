...
/* System Settings */
    ...
    house_limit = 40; //Maximum number of houses a player can own.
    ...
    sendtoJail_locations[] = { "police_jail_point" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    jail_forceWalk = true;
    ...
    seize_uniform[] = { "U_Rangemaster", "U_O_GhillieSuit", "U_I_GhillieSuit", "U_O_FullGhillie_lsh", "U_O_FullGhillie_sard", "U_O_FullGhillie_ard", "U_I_FullGhillie_lsh", "U_I_FullGhillie_sard", "U_I_FullGhillie_ard" }; //Any specific uniforms you want to be seized from players
    seize_vest[] = { "V_TacVest_blk_POLICE", "V_TacVest_khk", "V_TacVest_blk", "V_Chestrig_blk", "V_BandollierB_cbr", "V_TacVestCamo_khk", "V_PlateCarrierL_CTRG", "V_PlateCarrierH_CTRG", "V_PlateCarrierGL_mtp", "V_PlateCarrierSpec_mtp", "V_PlateCarrierIAGL_oli", "V_HarnessOGL_brn" }; //Any specific vests you want to be seized from players
